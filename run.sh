...
HF_HOME=/mnt/LLM \
deepspeed  --master_port 29771 --include=localhost:5,7 \
./run2.py --model meta-llama/Llama-2-7b-hf  --batch_size 1  --dtype float16 --max_tokens 2048 --max_new_tokens 256 --end_id 40 --out_file out_0.json
